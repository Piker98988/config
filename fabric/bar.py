    ...
    def __init__(self, **kwargs):
        ...
        self.event_box = EventBox(
            ...
            children=Overlay(
                ...
                overlays=Label(
                    label="",
                    style="margin: 1px 0px 0px 0px; font-size: 12px",  # because glyph icon is not centered
                ),
            ),
        )
    ...
    def __init__(
        ...
        self.active_window = ActiveWindow(
            formatter=FormattedString(
                ...
                if x != "org.wezfurlong.wezterm"
                else "Wezterm",
            ),
            name="hyprland-window",
        )
        self.language = Language("video-bus",
            formatter=FormattedString(
                "{language}", # language was surrounded by replace_lang()
